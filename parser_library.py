...
def get_all_books(path_local_archive):
    ...
    all_books_link = (["/ebooks/" + str(n)
        for n in range(3045,max_book_id)
        if n])
...
def get_all_meta(path_local_archive):
    max_book_id = 57122
    all_books_link = (["/ebooks/" + str(n)
...
class Books:
    ...
    def get_book_data(self):
        ...
        return self.title, self.author,self.directory,self.text_link ,self.subjects, self.language 
